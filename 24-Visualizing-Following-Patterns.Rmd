...
```{r followers_already_loaded, message=FALSE, warning=FALSE}

# If already available, we can load directly:
followers_data <- readRDS("hadley_followers_2018-07-21.RDS")

# This file's pretty big, 175 Mb when run in July 2018.
format(object.size(followers_data), units = "auto")
```
